...
export const home = () => {
  const render = () => {
    const contentMsg = `
      <p>Hello. My name is Cha Haneum.<br/>
      ...
      you can view more blog posts by clicking on <a href="/feed">the blog post title</a>, by clicking on <a href="/feed">/feed</a> or by typing <a href="/feed">/feed</a> after your domain.</p>
