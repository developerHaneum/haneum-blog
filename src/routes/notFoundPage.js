export const notFoundPage = () => {
  return `
    <div>
      <div style="padding: 1vh 1vh 1vh 1vh; height: 100vh; font-size: 2.5vh;">
        <h1 style="font-weight: 500; font-size: 2.8125vh; padding-bottom: 1.40625vh;">404 Not found page</h1>
        <p style="line-height: 3.0625vh;">Sorry, Access the web page via a web page link or through an address you know.</p>
